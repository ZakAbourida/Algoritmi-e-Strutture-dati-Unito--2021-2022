...
static void quicksort_test_array_is_empty_zero_el() {
	MyArray *my_array = my_array_create();
	sort_array_with_quicksort(my_array, precedes_int);

	TEST_ASSERT_TRUE(my_array_is_empty(my_array));
	my_array_free_memory(my_array);
}

static void quicksort_test_array_is_empty_one_el() {
	MyArray *my_array = my_array_create();
	int i1 = -12;
...
static void quicksort_test_array_size_zero_el() {
	MyArray *my_array = my_array_create();
	sort_array_with_quicksort(my_array, precedes_int);
...
static void quicksort_test_array_size_one_el() {
	MyArray *my_array = my_array_create();
	int i1 = -12;
	my_array_add(my_array, (void*)&i1);
	sort_array_with_quicksort(my_array, precedes_int);
...
static void quicksort_test_array_size_two_el() {
	MyArray *my_array = my_array_create();
	int i1 = -12;
	my_array_add(my_array, (void*)&i1);
	int i2 = 2;
...
static void quicksort_test_array_add_get_one_el() {
	MyArray *my_array = my_array_create();
	int i1 = -12;
	my_array_add(my_array, (void*)&i1);
...
static void quicksort_test_array_add_get_three_el() {
	int i1 = -12;
	int i2 = 0;
	int i3 = 4;
...
static void quicksort_test_array_all_same(){
...
static void quicksort_test_array_already_sorted(){
...
static void quicksort_test_array_inverted_order(){
...
int main() {
	UNITY_BEGIN();
	RUN_TEST(quicksort_test_array_is_empty_zero_el);
	RUN_TEST(quicksort_test_array_is_empty_one_el);
	RUN_TEST(quicksort_test_array_size_zero_el);
	RUN_TEST(quicksort_test_array_size_one_el);
	RUN_TEST(quicksort_test_array_size_two_el);
	RUN_TEST(quicksort_test_array_add_get_one_el);
	RUN_TEST(quicksort_test_array_add_get_three_el);
	RUN_TEST(quicksort_test_array_all_same);
	RUN_TEST(quicksort_test_array_already_sorted);
	RUN_TEST(quicksort_test_array_inverted_order);
